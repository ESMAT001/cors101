...
exports.proxy_request_timeout_ms = Infinity; // The lenght of time we'll wait for a proxy server to respond before timing out.
exports.max_request_length = Infinity; // The maximum length of characters allowed for a request or a response.
